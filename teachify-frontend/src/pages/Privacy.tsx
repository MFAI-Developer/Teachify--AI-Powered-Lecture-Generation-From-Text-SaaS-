      ...
      <div className="container mx-auto px-4 py-10 md:py-12 max-w-4xl">
        <div className="mb-8 text-center">
          ...
          <p className="text-sm md:text-base text-muted-foreground max-w-2xl mx-auto">
            At Teachify, we take your privacy seriously. This Privacy Policy
          ...
          <div className="prose prose-sm md:prose-base max-w-none space-y-6 text-muted-foreground">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  Content you create (prompts, uploaded documents, generated lectures)
                </li>
            ...
            <section>
              ...
              <p>
                ...
                <a
                  href="mailto:privacy@teachify.ai"
